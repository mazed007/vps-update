...
class TrialPinController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            array_push($this->messages, 'Trial Pin has been addedd.');
            $status = 1;
            session()->flash('flash', [
                'status' => $status,
    ...
    public function edit($id)
    {
        ...
        return view('trial.edit', compact('pin'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            array_push($this->messages, 'Trial Pin has been updated.');
            $status = 1;
            session()->flash('flash', [
                'status' => $status,
                'messages' => $this->messages,
    ...
    public function destroy($id)
    {
        try {
            ...
            array_push($this->messages, 'Trial Pin has been deleted.');
            $status = 1;
            session()->flash('flash', [
                'status' => $status,
                'messages' => $this->messages,
